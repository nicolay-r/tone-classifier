...
\begin{document}
    ...
    \input{parts/reviewed}

    % Описание подхода.
    \input{parts/description/approach}
    % Построение обучающих коллекций.
    \input{parts/description/train}
    % Построение лексиконов.
    \input{parts/description/lexicons}

    % Тестирование на коллекции 2015 года.
    \input{parts/2015/sentiRuEval2015}
    % Улучшения
    %\input{parts/2015/improvements}

    % Участие в соревнованиях 2016 года.
    %\input{parts/2016/sentiRuEval2016}
    % Информация об участниках.
    %\input{parts/2016/participants}
    % Вывод
