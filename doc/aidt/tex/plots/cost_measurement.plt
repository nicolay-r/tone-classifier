...
set output "../pics/2016_ttk_imbalanced.png"
plot "2016_ttk_imbalanced.dat" using 1:2 with linespoints title "TCC_01", \
    "2016_ttk_imbalanced.dat" using 1:3 with linespoints title "TCC_02",  \
    "2016_ttk_imbalanced.dat" using 1:4 with linespoints title "TCC_03",  \
    "2016_ttk_imbalanced.dat" using 1:5 with linespoints title "TCC_04",  \
    "2016_ttk_imbalanced.dat" using 1:6 with linespoints title "TCC_05",  \
    "2016_ttk_imbalanced.dat" using 1:7 with linespoints title "TCC_06"
