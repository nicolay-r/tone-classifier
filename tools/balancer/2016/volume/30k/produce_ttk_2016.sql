-- Для ttk коллекции
DROP TABLE IF EXISTS ttk_train_balanced_2016_30k;
CREATE TABLE ttk_train_balanced_2016_30k AS
...
--
INSERT INTO ttk_train_balanced_2016_30k(twitid, text, mts)
    SELECT twitid, text, rank FROM mtsd_positive limit(25000);
INSERT INTO ttk_train_balanced_2016_30k(twitid, text, mts)
    SELECT twitid, text, rank FROM mtsd_negative limit(23800);
INSERT INTO ttk_train_balanced_2016_30k(twitid, text, mts)
    SELECT twitid, text, rank FROM mtsd_neutral limit(21500);

-- Проверяем баллансировку
SELECT COUNT(*) FROM ttk_train_balanced_2016_30k WHERE
